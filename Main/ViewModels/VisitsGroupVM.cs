...
namespace Main.ViewModels
{
    ...
    {
        public IfDocCommandMenuItemVM(rootMenu root) : base(root)
        {
    ...
    internal class ProjectsGroupMenuFactory : IMenuItemClient
    {
        ...
        public void AddStaticMenus(IMenuItemServer s)
        {
            ...
            { 
                ...
                VMBase.ServiceProvider.GetRequiredService<LastVisitMenuVM>(),
                VMBase.ServiceProvider.GetRequiredService<LastFileMenuVM>()
            });
            ...
            s.Add(NewProject.ParentStaticRootID, new IfDocCommandMenuItemVM(NewProject)
            {
                IconSource = "pack://application:,,,/Images/NewProject.PNG",
                Command = new RelayCommand(() =>
                {
            ...
            s.Add(OpenProject.ParentStaticRootID, new IfDocCommandMenuItemVM(OpenProject)
            {
                IconSource = "pack://application:,,,/Images/OpenProject.PNG",
                Command = new RelayCommand(() =>
                {
